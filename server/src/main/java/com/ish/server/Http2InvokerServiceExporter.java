...
public class Http2InvokerServiceExporter extends HttpInvokerServiceExporter {
    ...
    protected RemoteInvocation readRemoteInvocation(HttpServletRequest request, InputStream is)
        ...
        return serializationService.deserialize(decorateInputStream(request, is), RemoteInvocation.class);
    }
    ...
    protected void writeRemoteInvocationResult(HttpServletRequest request, HttpServletResponse response,
        ...
        serializationService.serialize(result, decorateOutputStream(request, response, os));
    }
